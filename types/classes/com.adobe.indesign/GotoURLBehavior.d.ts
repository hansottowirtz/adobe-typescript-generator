...
declare namespace Adobe {
	namespace Indesign {
		class GotoURLBehavior extends Adobe.Indesign.Behavior {
			...
			/** The parent of the GotoURLBehavior (a Button). */
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoURLBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerGotoURLBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
