...
declare namespace Adobe {
	namespace Indesign {
		/** FormField */
		class CheckBox extends Adobe.Indesign.FormField {
			/**
			...
			/**
			 * The parent of the CheckBox (a Snippet, PlaceGun, Character, 
			 ...
			 */
			public addEventListenerCheckBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the CheckBox that are 
			 ...
			 * @param {any} toParam The location of the new CheckBox, 
			 ...
			 * CheckBox from the original CheckBox's position. (Optional)
			 ...
			 * @param {any} toParam The new location of the CheckBox,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the CheckBox relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
			 ...
			 * selection status of the CheckBox in relation to previously 
