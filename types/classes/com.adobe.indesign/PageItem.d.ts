...
declare namespace Adobe {
	namespace Indesign {
		class PageItem extends Adobe.Csawlib.CSHostObject {
			/**
			...
			/**
			 * The parent of the PageItem (a XMLElement, Spread, 
			 * MasterSpread, Polygon, GraphicLine, Rectangle, Oval, 
			 * SplineItem, Group, State, Character, Sound, PlaceGun, Movie 
			 * or Snippet).
			 */
			 ...
			 * (Optional)
			 */
			public addEventListenerPageItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the PageItem's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the PageItem 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The PageItem's new 
			 * shape.
			 ...
			 * @param {any} toParam - The location of the new PageItem, 
			 ...
			 * PageItem from the original PageItem's position. (Optional)
			 */
			 ...
			 * the PageItem. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerPageItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the PageItem in relation to previously 
