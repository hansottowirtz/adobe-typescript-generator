...
declare namespace Adobe {
	namespace Indesign {
		class PageItem extends Adobe.Csawlib.CSHostObject {
			...
			/**
			 * The parent of the PageItem (a Snippet, XMLElement, ComboBox, 
			 * ListBox, TextBox, SignatureField, Spread, MasterSpread, 
			 * Polygon, GraphicLine, Rectangle, Oval, SplineItem, Group, 
			 * State, Character, Sound, PlaceGun or Movie).
			 * @type {any}
			 * @readonly
			 */
			 ...
			 * attributes and formatting applied to the PageItem that are 
			 ...
			 * @param {any} toParam The new location of the PageItem,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the PageItem relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
