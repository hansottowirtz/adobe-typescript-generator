...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ScriptArg extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerScriptArg(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
