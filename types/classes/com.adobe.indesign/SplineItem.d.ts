...
declare namespace Adobe {
	namespace Indesign {
		class SplineItem extends Adobe.Indesign.PageItem {
			...
			/**
			 * The parent of the SplineItem (a Spread, MasterSpread, 
			 ...
			 * the SplineItem's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the SplineItem 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The SplineItem's 
			 * new shape.
			 ...
			 * the SplineItem. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * to move the SplineItem relative to its current position, in 
