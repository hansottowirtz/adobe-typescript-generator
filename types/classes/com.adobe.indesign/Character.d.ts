...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class Character extends Adobe.Indesign.Text {
			/**
			 ...
			 */
			public addEventListenerCharacter(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
