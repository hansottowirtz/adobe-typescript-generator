...
declare namespace Adobe {
	namespace Indesign {
		class Sounds extends Adobe.Csawlib.CSHostObject {
			 ...
			 * String.
			 * @param {any} toParam - The Sound, index, or name at the end 
			 * of the range. Can accept: Sound, Long Integer or String.
			 */
			 ...
			 * index.
			 * @param {Sound} objParam - The index of the Sound that 
			 * follows the desired Sound.
			 */
