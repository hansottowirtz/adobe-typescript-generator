...
declare namespace Adobe {
	namespace Indesign {
		/** PageItem */
		class HtmlItem extends Adobe.Indesign.PageItem {
			/**
			 ...
			 */
			public fixedDimensions: boolean;
			 ...
			 * (Optional)
			 */
			public addEventListenerHtmlItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the HtmlItem that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam The HtmlItem's new 
			 * shape.
			 ...
			 * @param {any} toParam The location of the new HtmlItem, 
			 ...
			 * HtmlItem from the original HtmlItem's position. (Optional)
			 */
			 ...
			 * @param {any} toParam The new location of the HtmlItem,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the HtmlItem relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerHtmlItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the HtmlItem in relation to previously 
