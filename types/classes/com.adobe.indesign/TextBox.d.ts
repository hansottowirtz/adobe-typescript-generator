...
declare namespace Adobe {
	namespace Indesign {
		/** FormField */
		class TextBox extends Adobe.Indesign.FormField {
			/**
			...
			/**
			 * The parent of the TextBox (a Snippet, PlaceGun, Character, 
			 ...
			 */
			public addEventListenerTextBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the TextBox that are 
			 ...
			 * @param {any} toParam The location of the new TextBox, 
			 ...
			 * TextBox from the original TextBox's position. (Optional)
			 ...
			 * @param {any} toParam The new location of the TextBox,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the TextBox relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
			 ...
			 * selection status of the TextBox in relation to previously 
