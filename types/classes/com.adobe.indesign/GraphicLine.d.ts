...
declare namespace Adobe {
	namespace Indesign {
		...
		class GraphicLine extends Adobe.Indesign.SplineItem {
			...
			/**
			 * The parent of the GraphicLine (a Snippet, ComboBox, ListBox, 
			 ...
			 * attributes and formatting applied to the GraphicLine that 
			 ...
			 * @param {any} toParam The new location of the GraphicLine,in 
			 ...
			 * move the GraphicLine relative to its current position, in 
