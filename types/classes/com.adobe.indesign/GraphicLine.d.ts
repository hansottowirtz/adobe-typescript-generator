...
declare namespace Adobe {
	namespace Indesign {
		class GraphicLine extends Adobe.Indesign.SplineItem {
			/**
			...
			/**
			 * The parent of the GraphicLine (a Spread, MasterSpread, 
			 ...
			 * (Optional)
			 */
			public addEventListenerGraphicLine(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * the GraphicLine's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the GraphicLine 
			 ...
			 * offset.
			 * @param {any} toParam - The location of the new GraphicLine, 
			 ...
			 * GraphicLine from the original GraphicLine's position. 
			 * (Optional)
			 */
			 ...
			 * the GraphicLine. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * GraphicLine,in the format (x, y). Can accept: Array of 2 
			 * Units, Spread, Page or Layer. (Optional)
			 * @param {any[]} byParam - The amount (in measurement units) 
			 * to move the GraphicLine relative to its current position, in 
			 ...
			 * selection status of the GraphicLine in relation to 
