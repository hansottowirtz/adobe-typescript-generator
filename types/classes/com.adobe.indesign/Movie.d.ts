...
declare namespace Adobe {
	namespace Indesign {
		/** MediaItem */
		class Movie extends Adobe.Indesign.MediaItem {
			/**
			 ...
			 * @type {Adobe.Indesign.FloatingWindowPosition}
			 */
			public floatingWindowPosition: Adobe.Indesign.FloatingWindowPosition;
			/**
			 * The size of the floating window that displays the movie.
			 * @type {Adobe.Indesign.FloatingWindowSize}
			 */
			public floatingWindowSize: Adobe.Indesign.FloatingWindowSize;
			/**
			 * The swatch (color, gradient, tint, or mixed ink) applied to 
			 ...
			 */
			public moviePosterType: Adobe.Indesign.MoviePosterTypes;
			/**
			 ...
			 * @type {Adobe.Indesign.NavigationPoints}
			 * @readonly
			 */
			public readonly navigationPoints: Adobe.Indesign.NavigationPoints;
			/**
			 ...
			 */
			public addEventListenerMovie(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the Movie that are not 
			 ...
			 */
			public duplicateMovie(): Adobe.Indesign.Movie;
			/**
			 ...
			 * @param {any} toParam The new location of the Movie,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the Movie relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
			 ...
			 * selection status of the Movie in relation to previously 
