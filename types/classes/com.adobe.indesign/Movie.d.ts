...
declare namespace Adobe {
	namespace Indesign {
		...
		class Movie extends Adobe.Indesign.MediaItem {
			 ...
			 * the Movie's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Movie that 
			 ...
			 * the Movie. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * to move the Movie relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
