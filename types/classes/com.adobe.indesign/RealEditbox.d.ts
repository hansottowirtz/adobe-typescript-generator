...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class RealEditbox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerRealEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerRealEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
