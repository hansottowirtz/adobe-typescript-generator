...
declare namespace Adobe {
	namespace Indesign {
		class FindChangeContentTransparencySetting extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerFindChangeContentTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerFindChangeContentTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
