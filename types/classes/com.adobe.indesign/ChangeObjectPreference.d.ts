...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ChangeObjectPreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeObjectPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerChangeObjectPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
