...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class MatchParagraphStylePreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerMatchParagraphStylePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
