...
declare namespace Adobe {
	namespace Indesign {
		class Fonts extends Adobe.Csawlib.CSHostObject {
			 ...
			 * String.
			 * @param {any} toParam - The Font, index, or name at the end 
			 * of the range. Can accept: Font, Long Integer or String.
			 */
			 ...
			 * the collection.
			 * @param {Font} objParam - The Font whose index comes before 
			 * the desired Font. 
			 */
