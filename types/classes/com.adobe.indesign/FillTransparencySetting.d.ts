...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class FillTransparencySetting extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerFillTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerFillTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
