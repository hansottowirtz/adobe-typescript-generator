...
declare namespace Adobe {
	namespace Indesign {
		/** FormField */
		class RadioButton extends Adobe.Indesign.FormField {
			/**
			...
			/**
			 * The parent of the RadioButton (a Snippet, PlaceGun, 
			 ...
			 */
			public addEventListenerRadioButton(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the RadioButton that 
			 ...
			 * @param {ConvertShapeOptions} givenParam The RadioButton's 
			 * new shape.
			 ...
			 * offset.
			 * @param {any} toParam The location of the new RadioButton, 
			 ...
			 * RadioButton from the original RadioButton's position. 
			 * (Optional)
			 ...
			 * @param {any} toParam The new location of the RadioButton,in 
			 ...
			 * move the RadioButton relative to its current position, in 
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerRadioButton(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the RadioButton in relation to 
