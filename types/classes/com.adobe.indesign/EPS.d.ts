...
declare namespace Adobe {
	namespace Indesign {
		class EPS extends Adobe.Indesign.Graphic {
			...
			/**
			 * The parent of the EPS (a XMLElement, PlaceGun, SplineItem, 
			 ...
			 * the EPS's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the EPS that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The EPS's new 
			 * shape.
			 ...
			 * @param {any} toParam - The location of the new EPS, 
			 ...
			 * EPS from the original EPS's position. (Optional)
			 */
			 ...
			 * the EPS. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * to move the EPS relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
