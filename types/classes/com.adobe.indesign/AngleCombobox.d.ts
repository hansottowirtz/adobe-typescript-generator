...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class AngleCombobox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerAngleCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerAngleCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
