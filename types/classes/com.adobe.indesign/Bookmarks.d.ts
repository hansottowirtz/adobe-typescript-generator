...
declare namespace Adobe {
	namespace Indesign {
		class Bookmarks extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @param {any} destinationParam - The bookmark destination. 
			 * Can accept: HyperlinkTextDestination, 
			 * HyperlinkPageDestination, HyperlinkExternalPageDestination 
			 * or Page.
			 ...
			 * or String.
			 * @param {any} toParam - The Bookmark, index, or name at the 
			 * end of the range. Can accept: Bookmark, Long Integer or 
			 * String.
			 */
