...
declare namespace Adobe {
	namespace Indesign {
		class OpenFileBehavior extends Adobe.Indesign.Behavior {
			...
			/** The parent of the OpenFileBehavior (a Button). */
			 ...
			 * (Optional)
			 */
			public addEventListenerOpenFileBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerOpenFileBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
