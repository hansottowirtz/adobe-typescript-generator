...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class StoryPreference extends Adobe.Indesign.Preference {
			...
			public storyDirection: Adobe.Indesign.StoryDirectionOptions;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerStoryPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
