...
declare namespace Adobe {
	namespace Indesign {
		class Story extends Adobe.Csawlib.CSHostObject {
			/**
			 ...
			 * @readonly
			 */
			public readonly storyType: Adobe.Indesign.StoryTypes;
			/**
			 * The swatch (color, gradient, tint, or mixed ink) applied to 
			 ...
			 */
			public addEventListenerStory(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerStory(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 */
			public storyEdit(): Adobe.Indesign.StoryWindow;
			/**
