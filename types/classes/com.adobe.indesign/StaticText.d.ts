...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class StaticText extends Adobe.Indesign.Widget {
			/**
			 ...
			 * @type {Adobe.Indesign.StaticAlignmentOptions}
			 */
			public staticAlignment: Adobe.Indesign.StaticAlignmentOptions;
			/**
			 ...
			 */
			public addEventListenerStaticText(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
