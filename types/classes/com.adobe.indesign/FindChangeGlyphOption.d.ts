...
declare namespace Adobe {
	namespace Indesign {
		class FindChangeGlyphOption extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerFindChangeGlyphOption(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
