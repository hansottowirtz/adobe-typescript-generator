...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class RealCombobox extends Adobe.Indesign.Widget {
			/**
			 ...
			 */
			public addEventListenerRealCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerRealCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
