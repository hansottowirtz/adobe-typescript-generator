...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class MeasurementEditbox extends Adobe.Indesign.Widget {
			/**
			 ...
			 */
			public addEventListenerMeasurementEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
