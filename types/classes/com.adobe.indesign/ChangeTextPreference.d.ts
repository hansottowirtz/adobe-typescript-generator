...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ChangeTextPreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * @type {any}
			 */
			public changeConditionsMode: any;
			/**
			 ...
			 */
			public addEventListenerChangeTextPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerChangeTextPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
