...
declare namespace Adobe {
	namespace Indesign {
		class PercentEditbox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerPercentEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerPercentEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
