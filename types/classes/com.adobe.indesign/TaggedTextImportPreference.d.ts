...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class TaggedTextImportPreference extends Adobe.Indesign.Preference {
			 ...
			 * publication.
			 */
			public styleConflict: Adobe.Indesign.StyleConflict;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerTaggedTextImportPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
