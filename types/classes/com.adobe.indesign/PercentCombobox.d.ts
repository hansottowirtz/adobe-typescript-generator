...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class PercentCombobox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerPercentCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerPercentCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
