...
declare namespace Adobe {
	namespace Indesign {
		...
		class EPSText extends Adobe.Indesign.PageItem {
			...
			/**
			 * The parent of the EPSText (a Snippet, PlaceGun, ComboBox, 
			 ...
			 * attributes and formatting applied to the EPSText that are 
			 ...
			 * @param {any} toParam The new location of the EPSText,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the EPSText relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
