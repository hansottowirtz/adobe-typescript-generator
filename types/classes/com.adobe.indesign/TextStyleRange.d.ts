...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class TextStyleRange extends Adobe.Indesign.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerTextStyleRange(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
