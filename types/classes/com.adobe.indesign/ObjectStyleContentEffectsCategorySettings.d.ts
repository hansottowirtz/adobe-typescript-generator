...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ObjectStyleContentEffectsCategorySettings extends Adobe.Indesign.Preference {
			/**
			 ...
			 */
			public addEventListenerObjectStyleContentEffectsCategorySettings(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerObjectStyleContentEffectsCategorySettings(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
