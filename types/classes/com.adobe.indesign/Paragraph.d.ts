...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class Paragraph extends Adobe.Indesign.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerParagraph(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
