...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class GotoLastPageBehavior extends Adobe.Indesign.Behavior {
			...
			/** The parent of the GotoLastPageBehavior (a Button). */
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoLastPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerGotoLastPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
