...
declare namespace Adobe {
	namespace Indesign {
		/** MediaItem */
		class Sound extends Adobe.Indesign.MediaItem {
			/**
			...
			public soundPosterType: Adobe.Indesign.SoundPosterTypes;
			 ...
			 * (Optional)
			 */
			public addEventListenerSound(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the Sound's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Sound that 
			...
			public duplicateSound(): Adobe.Indesign.Sound;
			/**
			 ...
			 * the Sound. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * @param {any} toParam - The new location of the Sound,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam - The amount (in measurement units) 
			 * to move the Sound relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
			 ...
			 * selection status of the Sound in relation to previously 
