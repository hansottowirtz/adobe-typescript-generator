...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class IntegerEditbox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerIntegerEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
