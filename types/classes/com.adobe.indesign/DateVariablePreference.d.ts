...
declare namespace Adobe {
	namespace Indesign {
		class DateVariablePreference extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerDateVariablePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
