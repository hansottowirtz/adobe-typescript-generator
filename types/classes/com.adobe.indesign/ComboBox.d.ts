...
declare namespace Adobe {
	namespace Indesign {
		/** FormField */
		class ComboBox extends Adobe.Indesign.FormField {
			/**
			...
			/**
			 * The parent of the ComboBox (a Snippet, PlaceGun, Character, 
			 * Spread, MasterSpread, SplineItem, Polygon, GraphicLine, 
			 * Rectangle, Oval or Group).
			 * @type {any}
			 * @readonly
			 */
			 ...
			 * @type {boolean}
			 */
			public rightToLeftField: boolean;
			/**
			 ...
			 */
			public addEventListenerComboBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the ComboBox that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam The ComboBox's new 
			 * shape.
			 ...
			 * @param {any} toParam The location of the new ComboBox, 
			 ...
			 * ComboBox from the original ComboBox's position. (Optional)
			 ...
			 * @param {any} toParam The new location of the ComboBox,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the ComboBox relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerComboBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the ComboBox in relation to previously 
