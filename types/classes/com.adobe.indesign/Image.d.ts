...
declare namespace Adobe {
	namespace Indesign {
		class Image extends Adobe.Indesign.Graphic {
			 ...
			 * Movie, SplineItem, Polygon, GraphicLine, Rectangle, Oval, 
			 * State or Snippet).
			 */
			 ...
			 * the Image's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Image that 
			 ...
			 * the Image. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * to move the Image relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
