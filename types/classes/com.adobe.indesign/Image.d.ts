...
declare namespace Adobe {
	namespace Indesign {
		/** Graphic */
		class Image extends Adobe.Indesign.Graphic {
			/**
			 ...
			 * @type {Adobe.Indesign.GraphicLayerOption}
			 * @readonly
			 */
			public readonly graphicLayerOptions: Adobe.Indesign.GraphicLayerOption;
			/**
			 ...
			 */
			public imageRenderingIntent: Adobe.Indesign.RenderingIntent;
			/**
			...
			/**
			 * The parent of the Image (a Snippet, XMLElement, Sound, 
			 * PlaceGun, Movie, TextBox, SignatureField, ComboBox, ListBox, 
			 * SplineItem, Polygon, GraphicLine, Rectangle, Oval or State).
			 * @type {any}
			 * @readonly
			 */
			 ...
			 * @readonly
			 */
			public readonly profileList: any;
			/**
			 ...
			 */
			public addEventListenerImage(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the Image that are not 
			 ...
			 * @param {ConvertShapeOptions} givenParam The Image's new 
			 * shape.
			 ...
			 * @param {any} toParam The location of the new Image, 
			 ...
			 * Image from the original Image's position. (Optional)
			 ...
			 * @param {any} toParam The new location of the Image,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the Image relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerImage(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the Image in relation to previously 
