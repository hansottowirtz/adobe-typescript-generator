...
declare namespace Adobe {
	namespace Indesign {
		...
		class ParagraphDestination extends Adobe.Indesign.HyperlinkTextDestination {
			/**
			 * The text or insertion point that the hyperlink points to. 
			 * Can also accept: Text.
			 * @type {Adobe.Indesign.InsertionPoint}
			 */
			public destinationText: Adobe.Indesign.InsertionPoint;
			/**
			 ...
			 */
			public addEventListenerParagraphDestination(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
