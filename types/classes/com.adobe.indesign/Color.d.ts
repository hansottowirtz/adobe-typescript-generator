...
declare namespace Adobe {
	namespace Indesign {
		/** Swatch */
		class Color extends Adobe.Indesign.Swatch {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerColor(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
