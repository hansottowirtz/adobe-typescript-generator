...
declare namespace Adobe {
	namespace Indesign {
		...
		class MultiStateObject extends Adobe.Indesign.FormField {
			 ...
			 * the MultiStateObject's existing attributes before applying 
			 * the style. (Optional)
			 * @param {boolean} 
			 ...
			 * the MultiStateObject. Can accept: Array of 2 Units or 
			 ...
			 * to move the MultiStateObject relative to its current 
