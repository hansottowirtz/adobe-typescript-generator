...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ChangeGrepPreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeGrepPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
