...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class SubmitFormBehavior extends Adobe.Indesign.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerSubmitFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerSubmitFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
