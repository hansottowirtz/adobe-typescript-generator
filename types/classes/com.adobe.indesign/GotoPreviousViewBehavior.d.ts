...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class GotoPreviousViewBehavior extends Adobe.Indesign.Behavior {
			/**
			 ...
			 */
			public addEventListenerGotoPreviousViewBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerGotoPreviousViewBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
