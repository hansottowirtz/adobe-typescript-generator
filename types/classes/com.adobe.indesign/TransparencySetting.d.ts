...
declare namespace Adobe {
	namespace Indesign {
		class TransparencySetting extends Adobe.Indesign.Preference {
			...
			/**
			 * The parent of the TransparencySetting (a PageItem, 
			 ...
			 * (Optional)
			 */
			public addEventListenerTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
