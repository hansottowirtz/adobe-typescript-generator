...
declare namespace Adobe {
	namespace Indesign {
		/** FormField */
		class ListBox extends Adobe.Indesign.FormField {
			/**
			...
			/**
			 * The parent of the ListBox (a Snippet, PlaceGun, Character, 
			 ...
			 * (Optional)
			 */
			public addEventListenerListBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * attributes and formatting applied to the ListBox that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam The ListBox's new 
			 * shape.
			 ...
			 * @param {any} toParam The location of the new ListBox, 
			 ...
			 * ListBox from the original ListBox's position. (Optional)
			 */
			 ...
			 * @param {any} toParam The new location of the ListBox,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the ListBox relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerListBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the ListBox in relation to previously 
