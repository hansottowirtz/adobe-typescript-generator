...
declare namespace Adobe {
	namespace Indesign {
		class XMLTag extends Adobe.Csawlib.CSHostObject {
			 ...
			 * (Optional)
			 */
			public addEventListenerXMLTag(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			...
			/**
			 * Deletes the tag.
			 * @param {any} replacingWithParam - The tag to substitute. Can 
			 ...
			 * (Optional)
			 */
			public removeEventListenerXMLTag(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
