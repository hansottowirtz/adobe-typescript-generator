...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class TextColumn extends Adobe.Indesign.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerTextColumn(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
