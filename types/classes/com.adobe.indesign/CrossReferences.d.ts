...
declare namespace Adobe {
	namespace Indesign {
		class CrossReferences extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @param {Topic} referencedTopicParam - The topic that the 
			 ...
			 * @param {any} fromParam - The CrossReference, index, or name 
			 * at the beginning of the range. Can accept: CrossReference, 
			 * Long Integer or String.
