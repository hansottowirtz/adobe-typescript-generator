...
declare namespace Adobe {
	namespace Indesign {
		class TextPreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * text.
			 */
			public addPages: Adobe.Indesign.AddPageOptions;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerTextPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
