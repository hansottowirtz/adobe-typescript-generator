...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class FindTransliteratePreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerFindTransliteratePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
