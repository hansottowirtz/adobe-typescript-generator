...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class Word extends Adobe.Indesign.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerWord(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
