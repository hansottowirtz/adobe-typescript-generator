...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class ClearFormBehavior extends Adobe.Indesign.Behavior {
			/**
			 ...
			 */
			public addEventListenerClearFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerClearFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
