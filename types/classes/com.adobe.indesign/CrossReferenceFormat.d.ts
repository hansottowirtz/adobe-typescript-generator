...
declare namespace Adobe {
	namespace Indesign {
		class CrossReferenceFormat extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @type {Adobe.Indesign.BuildingBlocks}
			 * @readonly
			 */
			public readonly buildingBlocks: Adobe.Indesign.BuildingBlocks;
			/**
			 ...
			 */
			public addEventListenerCrossReferenceFormat(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
