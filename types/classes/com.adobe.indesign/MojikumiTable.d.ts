...
declare namespace Adobe {
	namespace Indesign {
		class MojikumiTable extends Adobe.Csawlib.CSHostObject {
			 ...
			 */
			public basedOnMojikumiSet: Adobe.Indesign.MojikumiTableDefaults;
			/**
			 ...
			 */
			public addEventListenerMojikumiTable(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
