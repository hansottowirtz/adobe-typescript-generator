...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ChangeTransliteratePreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * enumerator or NothingEnum enumerator.
			 */
			public changeCharacterType: any;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeTransliteratePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerChangeTransliteratePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
