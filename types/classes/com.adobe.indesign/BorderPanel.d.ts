...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class BorderPanel extends Adobe.Indesign.Widget {
			 ...
			 * (Optional)
			 */
			public addEventListenerBorderPanel(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerBorderPanel(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
