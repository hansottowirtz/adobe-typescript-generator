...
declare namespace Adobe {
	namespace Indesign {
		class Column extends Adobe.Csawlib.CSHostObject {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerColumn(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * selection status of the Column in relation to previously 
