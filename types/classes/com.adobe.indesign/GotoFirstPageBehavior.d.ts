...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class GotoFirstPageBehavior extends Adobe.Indesign.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoFirstPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
