...
declare namespace Adobe {
	namespace Indesign {
		class KinsokuTable extends Adobe.Csawlib.CSHostObject {
			 ...
			 * (Optional)
			 */
			public addEventListenerKinsokuTable(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerKinsokuTable(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
