...
declare namespace Adobe {
	namespace Indesign {
		class Oval extends Adobe.Indesign.SplineItem {
			...
			/**
			 * The parent of the Oval (a Spread, MasterSpread, SplineItem, 
			 * Polygon, GraphicLine, Rectangle, Oval, Group, State, 
			 * Character, PlaceGun or Snippet).
			 */
			 ...
			 * the Oval's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Oval that 
			 ...
			 * @param {any} toParam - The location of the new Oval, 
			 ...
			 * the Oval. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * to move the Oval relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
