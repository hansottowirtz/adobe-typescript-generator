...
declare namespace Adobe {
	namespace Indesign {
		class MovieBehavior extends Adobe.Indesign.Behavior {
			...
			public label: string;
			/** The movie page item. */
			public movieItem: Adobe.Indesign.Movie;
			 ...
			 * Navigation Point.
			 */
			public navigationPointID: number;
			/** The playback mode. */
			public operation: Adobe.Indesign.MoviePlayOperations;
			/** The parent of the MovieBehavior (a Button). */
			 ...
			 * (Optional)
			 */
			public addEventListenerMovieBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
