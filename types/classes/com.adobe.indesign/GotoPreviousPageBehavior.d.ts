...
declare namespace Adobe {
	namespace Indesign {
		class GotoPreviousPageBehavior extends Adobe.Indesign.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoPreviousPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
