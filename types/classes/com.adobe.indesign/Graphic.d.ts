...
declare namespace Adobe {
	namespace Indesign {
		...
		class Graphic extends Adobe.Indesign.PageItem {
			...
			/**
			 * The parent of the Graphic (a Snippet, XMLElement, Sound, 
			 * PlaceGun, Movie, TextBox, SignatureField, ComboBox, ListBox, 
			 * Polygon, GraphicLine, Rectangle, Oval, SplineItem or State).
			 * @type {any}
			 * @readonly
			 */
			 ...
			 * attributes and formatting applied to the Graphic that are 
			 ...
			 * @param {any} toParam The new location of the Graphic,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam The amount (in measurement units) to 
			 * move the Graphic relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
