...
declare namespace Adobe {
	namespace Indesign {
		class Graphic extends Adobe.Indesign.PageItem {
			 ...
			 * Movie, Polygon, GraphicLine, Rectangle, Oval, SplineItem, 
			 * State or Snippet).
			 */
			 ...
			 * (Optional)
			 */
			public addEventListenerGraphic(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the Graphic's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Graphic that 
			 ...
			 * @param {any} toParam - The location of the new Graphic, 
			 ...
			 * Graphic from the original Graphic's position. (Optional)
			 */
			 ...
			 * the Graphic. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * selection status of the Graphic in relation to previously 
