...
declare namespace Adobe {
	namespace Indesign {
		...
		class MediaItem extends Adobe.Indesign.PageItem {
			 ...
			 * attributes and formatting applied to the MediaItem that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam The MediaItem's new 
			 * shape.
			 ...
			 * move the MediaItem relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
