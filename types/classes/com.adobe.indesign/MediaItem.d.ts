...
declare namespace Adobe {
	namespace Indesign {
		class MediaItem extends Adobe.Indesign.PageItem {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerMediaItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the MediaItem's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the MediaItem 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The MediaItem's 
			 * new shape.
			 ...
			 * offset.
			 * @param {any} toParam - The location of the new MediaItem, 
			 ...
			 * MediaItem from the original MediaItem's position. (Optional)
			 */
			 ...
			 * the MediaItem. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerMediaItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the MediaItem in relation to previously 
