...
declare namespace Adobe {
	namespace Indesign {
		...
		class FormField extends Adobe.Indesign.PageItem {
			...
			/**
			 * The parent of the FormField (a Snippet, PlaceGun, Spread, 
			 ...
			 * attributes and formatting applied to the FormField that are 
			 ...
			 * move the FormField relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
