...
declare namespace Adobe {
	namespace Indesign {
		class FormField extends Adobe.Indesign.PageItem {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerFormField(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the FormField's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the FormField 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The FormField's 
			 * new shape.
			 ...
			 * offset.
			 * @param {any} toParam - The location of the new FormField, 
			 ...
			 * FormField from the original FormField's position. (Optional)
			 */
			 ...
			 * the FormField. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * selection status of the FormField in relation to previously 
