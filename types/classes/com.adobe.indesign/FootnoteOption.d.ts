...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class FootnoteOption extends Adobe.Indesign.Preference {
			/**
			 ...
			 * the footnote text.
			 */
			public footnoteFirstBaselineOffset: Adobe.Indesign.FootnoteFirstBaseline;
			/**
			 * The character style to apply to footnote reference numbers 
			 * in the main text.
			 */
			public footnoteMarkerStyle: Adobe.Indesign.CharacterStyle;
			/**
			 ...
			 */
			public footnoteTextStyle: Adobe.Indesign.ParagraphStyle;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerFootnoteOption(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
