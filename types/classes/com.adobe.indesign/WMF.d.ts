...
declare namespace Adobe {
	namespace Indesign {
		...
		class WMF extends Adobe.Indesign.Graphic {
			...
			/**
			 * The parent of the WMF (a Snippet, XMLElement, PlaceGun, 
			 ...
			 * attributes and formatting applied to the WMF that are not 
			 ...
			 * @param {ConvertShapeOptions} givenParam The WMF's new shape.
			 ...
			 * @param {any} toParam The location of the new WMF, specified 
			 * in coordinates in the format [x, y]. Can accept: Array of 2 
			 * Units, Spread, Page or Layer. (Optional)
			 * @param {any[]} byParam Amount by which to offset the new WMF 
			 * from the original WMF's position. (Optional)
			 ...
			 * move the WMF relative to its current position, in the format 
			 * (x, y). (Optional)
			 * @returns {void}
			 */
