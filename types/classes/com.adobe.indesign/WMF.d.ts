...
declare namespace Adobe {
	namespace Indesign {
		/** Graphic */
		class WMF extends Adobe.Indesign.Graphic {
			/**
			...
			/**
			 * The parent of the WMF (a XMLElement, PlaceGun, SplineItem, 
			 ...
			 * (Optional)
			 */
			public addEventListenerWMF(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the WMF's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the WMF that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The WMF's new 
			 * shape.
			 ...
			 * @param {any} toParam - The location of the new WMF, 
			 ...
			 * WMF from the original WMF's position. (Optional)
			 */
			 ...
			 * the WMF. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * @param {any} toParam - The new location of the WMF,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam - The amount (in measurement units) 
			 * to move the WMF relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerWMF(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the WMF in relation to previously 
