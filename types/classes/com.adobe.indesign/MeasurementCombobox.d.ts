...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class MeasurementCombobox extends Adobe.Indesign.Widget {
			/**
			 ...
			 * @type {Adobe.Indesign.MeasurementUnits}
			 */
			public editUnits: Adobe.Indesign.MeasurementUnits;
			/**
			 ...
			 */
			public addEventListenerMeasurementCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
