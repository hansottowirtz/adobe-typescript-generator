...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class ObjectStyleFillEffectsCategorySettings extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerObjectStyleFillEffectsCategorySettings(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerObjectStyleFillEffectsCategorySettings(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
