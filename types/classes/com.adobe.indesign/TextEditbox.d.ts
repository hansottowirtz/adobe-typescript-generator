...
declare namespace Adobe {
	namespace Indesign {
		/** Widget */
		class TextEditbox extends Adobe.Indesign.Widget {
			/**
			 ...
			 */
			public addEventListenerTextEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
