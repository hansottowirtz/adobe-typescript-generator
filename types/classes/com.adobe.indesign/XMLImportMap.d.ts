...
declare namespace Adobe {
	namespace Indesign {
		class XMLImportMap extends Adobe.Csawlib.CSHostObject {
			 ...
			 */
			public readonly markupTag: Adobe.Indesign.XMLTag;
			 ...
			 * (Optional)
			 */
			public addEventListenerXMLImportMap(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
