...
declare namespace Adobe {
	namespace Indesign {
		class IdleTask extends Adobe.Csawlib.CSHostObject {
			 ...
			 * (Optional)
			 */
			public addEventListenerIdleTask(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerIdleTask(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
