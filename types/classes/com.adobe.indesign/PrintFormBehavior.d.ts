...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class PrintFormBehavior extends Adobe.Indesign.Behavior {
			/**
			 ...
			 */
			public addEventListenerPrintFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerPrintFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
