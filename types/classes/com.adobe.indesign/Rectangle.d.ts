...
declare namespace Adobe {
	namespace Indesign {
		...
		class Rectangle extends Adobe.Indesign.SplineItem {
			...
			/**
			 * The parent of the Rectangle (a Snippet, ComboBox, ListBox, 
			 ...
			 * attributes and formatting applied to the Rectangle that are 
			 ...
			 * @param {ConvertShapeOptions} givenParam The Rectangle's new 
			 * shape.
			 ...
			 * move the Rectangle relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
