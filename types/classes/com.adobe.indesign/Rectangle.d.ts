...
declare namespace Adobe {
	namespace Indesign {
		/** SplineItem */
		class Rectangle extends Adobe.Indesign.SplineItem {
			/**
			...
			/**
			 * The parent of the Rectangle (a Spread, MasterSpread, 
			 ...
			 * (Optional)
			 */
			public addEventListenerRectangle(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * the Rectangle's existing attributes before applying the 
			 * style. (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the Rectangle 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The Rectangle's 
			 * new shape.
			 ...
			 * offset.
			 * @param {any} toParam - The location of the new Rectangle, 
			 ...
			 * Rectangle from the original Rectangle's position. (Optional)
			 */
			 ...
			 * the Rectangle. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * (Optional)
			 */
			public removeEventListenerRectangle(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 ...
			 * selection status of the Rectangle in relation to previously 
