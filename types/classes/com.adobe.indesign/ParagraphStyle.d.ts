...
declare namespace Adobe {
	namespace Indesign {
		class ParagraphStyle extends Adobe.Csawlib.CSHostObject {
			 ...
			 */
			public nextStyle: Adobe.Indesign.ParagraphStyle;
			 ...
			 * (Optional)
			 */
			public addEventListenerParagraphStyle(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/** Convert bullets and numbering to text. */
			public convertBulletsAndNumberingToText(): void;
			/** Duplicates the ParagraphStyle. */
			public duplicate(): Adobe.Indesign.ParagraphStyle;
			/**
			 ...
			 */
			public move(toParam: LocationOptions, referenceParam: any): Adobe.Indesign.ParagraphStyle;
			/**
			 * Deletes the style.
