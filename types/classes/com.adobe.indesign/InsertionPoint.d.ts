...
declare namespace Adobe {
	namespace Indesign {
		/** Text */
		class InsertionPoint extends Adobe.Indesign.Text {
			/**
			 ...
			 */
			public addEventListenerInsertionPoint(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
