...
declare namespace Adobe {
	namespace Indesign {
		class RadiobuttonControl extends Adobe.Indesign.Widget {
			 ...
			 * (Optional)
			 */
			public addEventListenerRadiobuttonControl(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
