...
declare namespace Adobe {
	namespace Indesign {
		/** Behavior */
		class ViewZoomBehavior extends Adobe.Indesign.Behavior {
			...
			/** The parent of the ViewZoomBehavior (a Button). */
			...
			/** The view zoom style. */
			public viewZoomStyle: Adobe.Indesign.ViewZoomStyle;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerViewZoomBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
