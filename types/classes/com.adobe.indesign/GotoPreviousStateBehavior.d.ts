...
declare namespace Adobe {
	namespace Indesign {
		class GotoPreviousStateBehavior extends Adobe.Indesign.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoPreviousStateBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
