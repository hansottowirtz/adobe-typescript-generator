...
declare namespace Adobe {
	namespace Indesign {
		...
		class PICT extends Adobe.Indesign.Graphic {
			...
			/**
			 * The parent of the PICT (a Snippet, XMLElement, PlaceGun, 
			 ...
			 * attributes and formatting applied to the PICT that are not 
			 ...
			 * @param {any} toParam The location of the new PICT, specified 
			 ...
			 * move the PICT relative to its current position, in the 
			 * format (x, y). (Optional)
			 * @returns {void}
			 */
