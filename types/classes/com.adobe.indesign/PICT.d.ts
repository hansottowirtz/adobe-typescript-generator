...
declare namespace Adobe {
	namespace Indesign {
		class PICT extends Adobe.Indesign.Graphic {
			/**
			...
			/**
			 * The parent of the PICT (a XMLElement, PlaceGun, SplineItem, 
			 ...
			 * (Optional)
			 */
			public addEventListenerPICT(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 * Applies the specified object style.
			 * @param {ObjectStyle} usingParam - The object style to apply.
			 * @param {boolean} clearingOverridesParam - If true, clears 
			 * the PICT's existing attributes before applying the style. 
			 * (Optional)
			 * @param {boolean} 
			 * clearingOverridesThroughRootObjectStyleParam - If true, 
			 * clears attributes and formatting applied to the PICT that 
			 ...
			 * @param {ConvertShapeOptions} givenParam - The PICT's new 
			 * shape.
			 ...
			 * @param {any} toParam - The location of the new PICT, 
			 ...
			 * PICT from the original PICT's position. (Optional)
			 */
			 ...
			 * the PICT. Can accept: Array of 2 Units or AnchorPoint 
			 * enumerator. (Optional)
			 */
			 ...
			 * @param {any} toParam - The new location of the PICT,in the 
			 * format (x, y). Can accept: Array of 2 Units, Spread, Page or 
			 * Layer. (Optional)
			 * @param {any[]} byParam - The amount (in measurement units) 
			 * to move the PICT relative to its current position, in the 
			 * format (x, y). (Optional)
			 */
			 ...
			 * selection status of the PICT in relation to previously 
