...
declare namespace Adobe {
	namespace Indesign {
		class Words extends Adobe.Csawlib.CSHostObject {
			 ...
			 * String.
			 * @param {any} toParam - The Word, index, or name at the end 
			 * of the range. Can accept: Word, Long Integer or String.
			 */
			 ...
			 * the collection.
			 * @param {Word} objParam - The Word whose index comes before 
			 * the desired Word. 
			 */
