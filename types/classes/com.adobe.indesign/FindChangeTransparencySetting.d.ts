...
declare namespace Adobe {
	namespace Indesign {
		class FindChangeTransparencySetting extends Adobe.Indesign.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerFindChangeTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerFindChangeTransparencySetting(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
