...
declare namespace Adobe {
	namespace Indesign {
		/** Preference */
		class XMLPreference extends Adobe.Indesign.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerXMLPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
