...
declare namespace Adobe {
	namespace Indesign {
		class GotoNextViewBehavior extends Adobe.Indesign.Behavior {
			...
			/** The parent of the GotoNextViewBehavior (a Button). */
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoNextViewBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Indesign.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerGotoNextViewBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
