...
declare namespace Adobe {
	namespace Incopy {
		/** PageItem */
		class MediaItem extends Adobe.Incopy.PageItem {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerMediaItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
