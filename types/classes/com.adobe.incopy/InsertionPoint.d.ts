...
declare namespace Adobe {
	namespace Incopy {
		/** Text */
		class InsertionPoint extends Adobe.Incopy.Text {
			/**
			 ...
			 */
			public addEventListenerInsertionPoint(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerInsertionPoint(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam The 
			 * selection status of the InsertionPoint in relation to 
