...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class GotoPageBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
