...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class SubmitFormBehavior extends Adobe.Incopy.Behavior {
			/**
			 ...
			 */
			public addEventListenerSubmitFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
