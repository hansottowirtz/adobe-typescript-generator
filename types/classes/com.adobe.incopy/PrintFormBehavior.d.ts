...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class PrintFormBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerPrintFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
