...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class IntegerCombobox extends Adobe.Incopy.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerIntegerCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
