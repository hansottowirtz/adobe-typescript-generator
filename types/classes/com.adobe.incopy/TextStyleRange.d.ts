...
declare namespace Adobe {
	namespace Incopy {
		/** Text */
		class TextStyleRange extends Adobe.Incopy.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerTextStyleRange(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerTextStyleRange(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam - The 
			 * selection status of the TextStyleRange in relation to 
