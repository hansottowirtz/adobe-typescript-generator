...
declare namespace Adobe {
	namespace Incopy {
		/** FormField */
		class ComboBox extends Adobe.Incopy.FormField {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerComboBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
