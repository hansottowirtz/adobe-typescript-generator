...
declare namespace Adobe {
	namespace Incopy {
		class Text extends Adobe.Csawlib.CSHostObject {
			/**
			 ...
			 */
			public addEventListenerText(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerText(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam The 
			 * selection status of the Text in relation to previously 
