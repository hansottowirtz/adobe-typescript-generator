...
declare namespace Adobe {
	namespace Incopy {
		/** FormField */
		class RadioButton extends Adobe.Incopy.FormField {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerRadioButton(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
