...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class ChangeTransliteratePreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeTransliteratePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
