...
declare namespace Adobe {
	namespace Incopy {
		class Condition extends Adobe.Csawlib.CSHostObject {
			 ...
			 */
			public indicatorMethod: Adobe.Incopy.ConditionIndicatorMethod;
			/**
			 ...
			 * @type {Adobe.Incopy.ConditionUnderlineIndicatorAppearance}
			 */
			public underlineIndicatorAppearance: Adobe.Incopy.ConditionUnderlineIndicatorAppearance;
			/**
			 ...
			 */
			public addEventListenerCondition(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
