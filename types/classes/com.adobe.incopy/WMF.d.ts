...
declare namespace Adobe {
	namespace Incopy {
		/** Graphic */
		class WMF extends Adobe.Incopy.Graphic {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerWMF(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
