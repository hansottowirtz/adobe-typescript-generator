...
declare namespace Adobe {
	namespace Incopy {
		/** Graphic */
		class PDF extends Adobe.Incopy.Graphic {
			/**
			 ...
			 */
			public addEventListenerPDF(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
