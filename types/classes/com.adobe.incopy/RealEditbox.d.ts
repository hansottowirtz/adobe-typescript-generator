...
declare namespace Adobe {
	namespace Incopy {
		class RealEditbox extends Adobe.Incopy.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerRealEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
