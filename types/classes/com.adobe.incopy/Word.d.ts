...
declare namespace Adobe {
	namespace Incopy {
		/** Text */
		class Word extends Adobe.Incopy.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerWord(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerWord(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam - The 
			 * selection status of the Word in relation to previously 
