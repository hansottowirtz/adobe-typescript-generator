...
declare namespace Adobe {
	namespace Incopy {
		class ChangeTextPreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeTextPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
