...
declare namespace Adobe {
	namespace Incopy {
		class Paragraph extends Adobe.Incopy.Text {
			/**
			...
			public readonly bulletsAndNumberingResultText: string;
			/**
			...
			public readonly numberingResultNumber: number;
			 ...
			 * (Optional)
			 */
			public addEventListenerParagraph(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 */
			public convertToTable(columnSeparatorParam: string, rowSeparatorParam: string, numberOfColumnsParam: number): Adobe.Incopy.Table;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerParagraph(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam - The 
			 * selection status of the Paragraph in relation to previously 
