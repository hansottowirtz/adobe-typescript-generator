...
declare namespace Adobe {
	namespace Incopy {
		class HyperlinkPageItemSource extends Adobe.Csawlib.CSHostObject {
			...
			public sourcePageItem: Adobe.Incopy.PageItem;
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerHyperlinkPageItemSource(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
