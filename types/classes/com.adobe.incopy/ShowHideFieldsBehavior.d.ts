...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class ShowHideFieldsBehavior extends Adobe.Incopy.Behavior {
			...
			public readonly fieldsToHide: any;
			/** The visible interactive objects. */
			public readonly fieldsToShow: any;
			 ...
			 * (Optional)
			 */
			public addEventListenerShowHideFieldsBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerShowHideFieldsBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
