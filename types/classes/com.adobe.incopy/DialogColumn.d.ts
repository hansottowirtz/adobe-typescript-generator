...
declare namespace Adobe {
	namespace Incopy {
		class DialogColumn extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @type {Adobe.Incopy.DialogRows}
			 * @readonly
			 */
			public readonly dialogRows: Adobe.Incopy.DialogRows;
			/**
			 ...
			 */
			public addEventListenerDialogColumn(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
