...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class OpenFileBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerOpenFileBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
