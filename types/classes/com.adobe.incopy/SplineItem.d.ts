...
declare namespace Adobe {
	namespace Incopy {
		/** PageItem */
		class SplineItem extends Adobe.Incopy.PageItem {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerSplineItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
