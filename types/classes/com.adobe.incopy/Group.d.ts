...
declare namespace Adobe {
	namespace Incopy {
		/** PageItem */
		class Group extends Adobe.Incopy.PageItem {
			/**
			 ...
			 */
			public addEventListenerGroup(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
