...
declare namespace Adobe {
	namespace Incopy {
		class MenuSeparators extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public add(atParam: LocationOptions, referenceParam: MenuElement, withPropertiesParam: any): Adobe.Incopy.MenuSeparator;
			/**
			 * Returns any MenuSeparator in the collection.
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public anyItem(): Adobe.Incopy.MenuSeparator;
			/**
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public firstItem(): Adobe.Incopy.MenuSeparator;
			/**
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public item(indexParam: any): Adobe.Incopy.MenuSeparator;
			/**
			 * Returns the MenuSeparator with the specified ID.
			 * @param {number} idParam The ID.
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public itemByID(idParam: number): Adobe.Incopy.MenuSeparator;
			/**
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public lastItem(): Adobe.Incopy.MenuSeparator;
			/**
			 * Returns the middle MenuSeparator in the collection.
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public middleItem(): Adobe.Incopy.MenuSeparator;
			/**
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public nextItem(objParam: MenuSeparator): Adobe.Incopy.MenuSeparator;
			/**
			 ...
			 * @returns {Adobe.Incopy.MenuSeparator}
			 */
			public previousItem(objParam: MenuSeparator): Adobe.Incopy.MenuSeparator;
		}
	}
}