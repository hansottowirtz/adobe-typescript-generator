...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class PageNumberVariablePreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 */
			public scope: Adobe.Incopy.VariableScopes;
			/**
			 ...
			 */
			public addEventListenerPageNumberVariablePreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
