...
declare namespace Adobe {
	namespace Incopy {
		/** Graphic */
		class ImportedPage extends Adobe.Incopy.Graphic {
			/**
			 ...
			 * @type {Adobe.Incopy.GraphicLayerOption}
			 * @readonly
			 */
			public readonly graphicLayerOptions: Adobe.Incopy.GraphicLayerOption;
			/**
			 ...
			 * @readonly
			 */
			public readonly importedPageCrop: Adobe.Incopy.ImportedPageCropOptions;
			/**
			 ...
			 */
			public addEventListenerImportedPage(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
