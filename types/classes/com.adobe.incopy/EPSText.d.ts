...
declare namespace Adobe {
	namespace Incopy {
		/** PageItem */
		class EPSText extends Adobe.Incopy.PageItem {
			/**
			 ...
			 * Polygon, GraphicLine, Rectangle, Oval, Group, State or 
			 * Character).
			 */
			 ...
			 * (Optional)
			 */
			public addEventListenerEPSText(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
