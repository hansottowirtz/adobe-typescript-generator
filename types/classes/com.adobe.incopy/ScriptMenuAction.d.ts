...
declare namespace Adobe {
	namespace Incopy {
		/** MenuAction */
		class ScriptMenuAction extends Adobe.Incopy.MenuAction {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerScriptMenuAction(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
