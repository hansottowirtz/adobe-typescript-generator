...
declare namespace Adobe {
	namespace Incopy {
		class NumberingList extends Adobe.Csawlib.CSHostObject {
			 ...
			 * (Optional)
			 */
			public addEventListenerNumberingList(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * @param {NumberingList} replacingWithParam - The 
			 * NumberingList to apply in place of this one. (Optional)
			 */
