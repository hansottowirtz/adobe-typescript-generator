...
declare namespace Adobe {
	namespace Incopy {
		class Ink extends Adobe.Csawlib.CSHostObject {
			...
			public inkType: Adobe.Incopy.InkTypes;
			 ...
			 * (Optional)
			 */
			public addEventListenerInk(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
