...
declare namespace Adobe {
	namespace Incopy {
		class GotoPreviousViewBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoPreviousViewBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
