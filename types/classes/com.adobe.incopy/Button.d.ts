...
declare namespace Adobe {
	namespace Incopy {
		/** FormField */
		class Button extends Adobe.Incopy.FormField {
			/**
			 ...
			 * @type {Adobe.Incopy.AnimationBehaviors}
			 * @readonly
			 */
			public readonly animationBehaviors: Adobe.Incopy.AnimationBehaviors;
			/**
			 ...
			 * @type {Adobe.Incopy.GotoNextStateBehaviors}
			 * @readonly
			 */
			public readonly gotoNextStateBehaviors: Adobe.Incopy.GotoNextStateBehaviors;
			/**
			 ...
			 * @type {Adobe.Incopy.GotoPageBehaviors}
			 * @readonly
			 */
			public readonly gotoPageBehaviors: Adobe.Incopy.GotoPageBehaviors;
			/**
			 ...
			 * @type {Adobe.Incopy.GotoPreviousStateBehaviors}
			 * @readonly
			 */
			public readonly gotoPreviousStateBehaviors: Adobe.Incopy.GotoPreviousStateBehaviors;
			/**
			 ...
			 * @type {Adobe.Incopy.GotoStateBehaviors}
			 * @readonly
			 */
			public readonly gotoStateBehaviors: Adobe.Incopy.GotoStateBehaviors;
			/**
			 ...
			 */
			public addEventListenerButton(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
