...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class ChangeGlyphPreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerChangeGlyphPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
