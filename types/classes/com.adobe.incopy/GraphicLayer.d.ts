...
declare namespace Adobe {
	namespace Incopy {
		class GraphicLayer extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @type {Adobe.Incopy.GraphicLayers}
			 * @readonly
			 */
			 ...
			 */
			public addEventListenerGraphicLayer(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
