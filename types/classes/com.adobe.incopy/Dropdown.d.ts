...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class Dropdown extends Adobe.Incopy.Widget {
			 ...
			 * (Optional)
			 */
			public addEventListenerDropdown(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
