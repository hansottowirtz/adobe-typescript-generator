...
declare namespace Adobe {
	namespace Incopy {
		class Character extends Adobe.Incopy.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerCharacter(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
			 ...
			 * (Optional)
			 */
			public removeEventListenerCharacter(eventTypeParam: string, handlerParam: any, capturesParam: boolean): boolean;
			/**
			 * Selects the object.
			 * @param {SelectionOptions} existingSelectionParam - The 
			 * selection status of the Character in relation to previously 
