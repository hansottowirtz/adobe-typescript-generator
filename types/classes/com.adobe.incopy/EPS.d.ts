...
declare namespace Adobe {
	namespace Incopy {
		class EPS extends Adobe.Incopy.Graphic {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerEPS(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
