...
declare namespace Adobe {
	namespace Incopy {
		class Oval extends Adobe.Incopy.SplineItem {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerOval(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
