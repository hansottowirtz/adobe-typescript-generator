...
declare namespace Adobe {
	namespace Incopy {
		/** FormField */
		class SignatureField extends Adobe.Incopy.FormField {
			/**
			 ...
			 */
			public addEventListenerSignatureField(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
