...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class ClearFormBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerClearFormBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
