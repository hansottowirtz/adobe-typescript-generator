...
declare namespace Adobe {
	namespace Incopy {
		class InCopyExportOption extends Adobe.Incopy.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerInCopyExportOption(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
