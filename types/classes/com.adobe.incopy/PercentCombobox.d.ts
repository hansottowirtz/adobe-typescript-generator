...
declare namespace Adobe {
	namespace Incopy {
		class PercentCombobox extends Adobe.Incopy.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerPercentCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
