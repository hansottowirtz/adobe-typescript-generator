...
declare namespace Adobe {
	namespace Incopy {
		/** Graphic */
		class Image extends Adobe.Incopy.Graphic {
			/**
			 ...
			 */
			public addEventListenerImage(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
