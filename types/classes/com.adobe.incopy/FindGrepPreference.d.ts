...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class FindGrepPreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerFindGrepPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
