...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class BorderPanel extends Adobe.Incopy.Widget {
			/**
			 ...
			 */
			public addEventListenerBorderPanel(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
