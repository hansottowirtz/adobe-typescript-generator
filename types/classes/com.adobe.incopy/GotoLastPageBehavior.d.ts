...
declare namespace Adobe {
	namespace Incopy {
		/** Behavior */
		class GotoLastPageBehavior extends Adobe.Incopy.Behavior {
			 ...
			 * (Optional)
			 */
			public addEventListenerGotoLastPageBehavior(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
