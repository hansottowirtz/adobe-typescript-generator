...
declare namespace Adobe {
	namespace Incopy {
		class PageItem extends Adobe.Csawlib.CSHostObject {
			 ...
			 * SplineItem, Group, State, Character, Page, Sound, PlaceGun 
			 * or Movie).
			 */
			 ...
			 * (Optional)
			 */
			public addEventListenerPageItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
