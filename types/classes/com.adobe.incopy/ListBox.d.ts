...
declare namespace Adobe {
	namespace Incopy {
		/** FormField */
		class ListBox extends Adobe.Incopy.FormField {
			/**
			 ...
			 * PDF.
			 */
			public readonly choiceList: any;
			 ...
			 */
			public readonly multipleSelection: boolean;
			...
			public readonly sortChoices: boolean;
			 ...
			 * (Optional)
			 */
			public addEventListenerListBox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
