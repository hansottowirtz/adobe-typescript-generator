...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class FindTextPreference extends Adobe.Incopy.Preference {
			/**
			 ...
			 */
			public addEventListenerFindTextPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
