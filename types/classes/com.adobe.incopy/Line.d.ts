...
declare namespace Adobe {
	namespace Incopy {
		/** Text */
		class Line extends Adobe.Incopy.Text {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerLine(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
