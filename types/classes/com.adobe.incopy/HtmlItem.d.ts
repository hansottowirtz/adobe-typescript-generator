...
declare namespace Adobe {
	namespace Incopy {
		/** PageItem */
		class HtmlItem extends Adobe.Incopy.PageItem {
			/**
			 ...
			 */
			public addEventListenerHtmlItem(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
