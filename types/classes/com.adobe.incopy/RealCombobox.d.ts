...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class RealCombobox extends Adobe.Incopy.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerRealCombobox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
