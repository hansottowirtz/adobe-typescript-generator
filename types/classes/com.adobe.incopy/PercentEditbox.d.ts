...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class PercentEditbox extends Adobe.Incopy.Widget {
			/**
			 ...
			 * (Optional)
			 */
			public addEventListenerPercentEditbox(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
