...
declare namespace Adobe {
	namespace Incopy {
		class Preference extends Adobe.Csawlib.CSHostObject {
			 ...
			 * MultiStateObject, FormField, Sound, Movie, MediaItem, 
			 * ImportedPage, PICT, WMF, PDF, EPS, Image, Graphic, PageItem, 
			 * TextWrapPreference, Page, Link, TextDefault, ParagraphStyle, 
