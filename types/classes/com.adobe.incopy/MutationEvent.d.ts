...
declare namespace Adobe {
	namespace Incopy {
		class MutationEvent extends Adobe.Incopy.Event {
			 ...
			 * Cell, IdleTask, Event, ImportExportEvent, DocumentEvent, 
			 * MutationEvent, IdleEvent, PrintEvent, EventListener, 
			 * StrokeStyle, GraphicLayer, NonIDBasedObject, Panel, Window, 
			 * NavigationPoint, BuildingBlock, IndexingSortOption, 
			 * TextMacro, MenuElement, MenuSeparator, MenuItem, Submenu, 
			 * Menu, TextVariable, ValidationError, XMLExportMap, 
			 * XMLImportMap, XMLAttribute, Row, Column, Change, RootObject, 
			 * Document, Application, Preference, 
