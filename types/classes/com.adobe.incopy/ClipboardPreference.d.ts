...
declare namespace Adobe {
	namespace Incopy {
		/** Preference */
		class ClipboardPreference extends Adobe.Incopy.Preference {
			 ...
			 * (Optional)
			 */
			public addEventListenerClipboardPreference(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
