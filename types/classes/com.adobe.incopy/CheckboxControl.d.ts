...
declare namespace Adobe {
	namespace Incopy {
		/** Widget */
		class CheckboxControl extends Adobe.Incopy.Widget {
			 ...
			 * (Optional)
			 */
			public addEventListenerCheckboxControl(eventTypeParam: string, handlerParam: any, capturesParam: boolean): Adobe.Incopy.EventListener;
			/**
