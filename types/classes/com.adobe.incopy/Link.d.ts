...
declare namespace Adobe {
	namespace Incopy {
		class Link extends Adobe.Csawlib.CSHostObject {
			 ...
			 * @type {Adobe.Incopy.LinkMetadata}
			 * @readonly
			 */
			public readonly linkXmp: Adobe.Incopy.LinkMetadata;
			/**
			 ...
			 * @readonly
			 */
			public readonly status: Adobe.Incopy.LinkStatus;
			/**
			 ...
			 */
			public update(): Adobe.Incopy.Link;
		}
	}
}