...
declare namespace Adobe {
	namespace Cshostadapter {
		class ICScriptingEventAdapter extends Adobe.Flash.Events.EventDispatcher {
			 ...
			 * @param {string} eventType
			 * @param {Function} listener
			 * @param {Adobe.Csawlib.CSHostObject} scriptingObj
			 * @param {boolean} useCapture
			 ...
			 * @returns {Adobe.Cshostadapter.ICScriptingEventAdapter}
			 */
			 ...
			 * @returns {boolean}
			 */
			public removeEventListenerFromObject(eventType: string, listener: Function, scriptingObj: Adobe.Csawlib.CSHostObject, useCapture: boolean): boolean;
		}
	}
}